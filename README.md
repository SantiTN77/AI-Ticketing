...
Crear ticket (modal “Crear ticket”) con descripción.

Procesar (envía ticket_id + description al webhook de n8n).

Ver realtime update en la tabla sin refrescar.

Reprocesar el mismo ticket para validar idempotencia (processed=true).
